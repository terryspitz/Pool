...
let fastCosTest () = 
    ...
    Assert.AreEqual(0. ,fastCos((1./2.)))
    Assert.AreEqual(-1., fastCos(1.))
    Assert.AreEqual(0. ,fastCos(3./2.))
    Assert.AreEqual(1. ,fastCos(2.))
    Assert.AreEqual(0. ,fastCos(5./2.))
    Assert.AreEqual(-1., fastCos(3.))
    Assert.AreEqual(0. ,fastCos(-1./2.))
    Assert.AreEqual(-1., fastCos(-1.))
    Assert.AreEqual(0. ,fastCos(-3./2.))
    Assert.AreEqual(1. ,fastCos(-2.))
